...
public class UndirectWeightedGraph {
	...
	public void readFile() {
		...
		E[0] = new Edge('0', 5, '1');// 빈칸 1
		E[1] = new Edge('0', 4, '2');// 빈칸 2
		E[2] = new Edge('1', 7, '3');// 빈칸 3
		E[3] = new Edge('1', 2, '2');// 빈칸 4
		E[4] = new Edge('2', 6, '3');// 빈칸 5
		E[5] = new Edge('2', 11, '4');// 빈칸 6
		E[6] = new Edge('3', 3, '4');// 빈칸 7
		E[7] = new Edge('3', 8, '5');// 빈칸 8
		E[8] = new Edge('4', 8, '5');// 빈칸 9
	...
	private void addNode(char node){ 
		if ( V.indexOf(node) == -1 )//v에 node없으면 -1반환
			V += node;// 빈칸을 채우시오: 문자열 V에 매개변수로 받은 node가 있는 지 확인하고 없다면 v에 node를 추가
